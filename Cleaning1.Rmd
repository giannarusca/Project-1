...
library(dplyr)
# need to load dplyr for arrange()
...
* merges the training and the testing sets,
...
```{r}
library(dplyr) #not a necessary step since dplyr is used above, but will be used in this function
